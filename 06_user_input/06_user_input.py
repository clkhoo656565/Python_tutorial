...
print('Please enter the num of days: ')
#Input() to give user a prompt to ask input value, PYTHON stops executing when it come to the Input()
num_of_days = input()

#calling the functions
scope_check(num_of_days)
days_to_units(50)